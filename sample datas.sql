...
CREATE TABLE  CUSTOMER
   (	CUST_CODE VARCHAR(6) NOT NULL PRIMARY KEY, 
	...
	GRADE integer, 
	OPENING_AMT integer(12) NOT NULL, 
	RECEIVE_AMT integer(12) NOT NULL, 
	PAYMENT_AMT integer(12) NOT NULL, 
	OUTSTANDING_AMT integer(12) NOT NULL, 
...
CREATE TABLE  ORDERS 
   (
	ORD_NUM integer(6) NOT NULL PRIMARY KEY, 
	ORD_AMOUNT integer(12) NOT NULL, 
	ADVANCE_AMOUNT integer(12) NOT NULL, 
